...
option = spacex_df['Launch Site'].unique()
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df["Launch Site"] == entered_site].groupby(spacex_df["class"]).count()
        fig = px.pie(filtered_df,values = 'class',
            names=filtered_df.index, 
...
def get_scatter_chart(entered_site,payload):
    ...
    if entered_site == 'ALL':
            ...
            filter_df = filtered_df[filtered_df["Launch Site"] == entered_site]
